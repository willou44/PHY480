...
main (void)
{
  ...
  params_ptr[0] = &alpha;		// double to pass to function 
  params_ptr[1] = &beta;		// double to pass to function 
...
test_function (double x, void *params_ptr)
{
  double alpha;
  double beta;
  alpha = *(double *) params_ptr[0];
  beta = *(double *) params_ptr[1];
